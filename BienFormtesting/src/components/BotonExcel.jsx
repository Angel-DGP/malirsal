...
const BotonExcel = ({ dataCSV }) => {
  const generateHeaders = () => [
    ...
    {
      label: "NOMBRE DEL CONVENIO / CONVOCATORIA / EVENTO INTERNACIONAL",
      key: "n_convenio",
    },
  ...
  const exportToExcel = () => {
    ...
    const titleStyle = {
      font: { bold: true, sz: 14 }, // Cambiar color y tamaño de fuente
      alignment: { horizontal: "center", vertical: "center" },
    };

    const subtitleStyle = {
      font: { bold: true, sz: 12, color: { rgb: "000000" } }, // Cambiar color y tamaño de fuente
      alignment: { horizontal: "center", vertical: "center" },
      fill: { fgColor: { rgb: "FFFFE0" } }, // Cambiar color de fondo
    };

    const headerStyle = {
      font: { bold: true, color: { rgb: "000000" } }, // Color de texto y negrita
